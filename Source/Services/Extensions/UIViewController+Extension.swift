...
//  RIBsCore
//
//  Created by Dmitry Savitskiy on 23/10/22.
//
...
extension UIViewController {
    public func attachChild(viewController: UIViewController, destinationView: UIView) {
    ...
    public func attachChild(viewController: UIViewController) {
        attachChild(viewController: viewController, destinationView: view)
    }
    
    public func detachChild(viewController: UIViewController) {
